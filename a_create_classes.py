...
class Carte(Base):
    ...
    def __init__(self, id_Carte, nom, id_Restaurant):
...
class CodePostal(Base):
    ...
    def __init__(self, id_CodePostal, code, id_Pays):
...
class Ville(Base):
    ...
    def __init__(self, id_Ville, nom, id_CodePostal):
...
class Adresse(Base):
    ...
    def __init__(self, id_Adresse, numero_adresse, voie_adresse, id_Ville):
...
class Ingredient(Base):
    ...
    def __init__(self, id_Ingredient, nom, prix_achat):
...
class Item(Base):
    ...
    def __init__(self, id_Item, nom, type, taille_boisson, prix_vente):
...
class Recette(Base):
    ...
    def __init__(self, id_Recette, nom, quantité, id_Ingredient, id_Item):
...
class Menu(Base):
    ...
    def __init__(self, id_Menu, nom, id_Item_plat, id_Item_boisson, id_Item_dessert):
...
class Restaurant(Base):
    ...
    def __init__(self, nom, espace_enfants, borne_service, accessible_pmr, parking, id_Carte, id_Employe_directeur, id_Adresse):
        self.nom = nom
...
class Employe(Base):
    ...
    def __init__(self, prenom, nom, date_embauche, num_compte, experience, id_Poste, id_Employe_responsable, id_Restaurant, id_Adresse_restaurant):
        self.prenom = prenom
        self.nom = nom
...
class Salaire(Base):
    ...
    def __init__(self, id_Salaire, note, montant, date_debut, date_fin, id_Employe):
...
class TicketCaisse(Base):
    ...
    def __init__(self, id_TicketCaisse, date_heure, moyen_paiement, id_vendeur):
